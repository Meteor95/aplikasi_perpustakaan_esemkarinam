                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row mb-1">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control" id="nomor_trx" placeholder="Kosongkan jika ingin nota otomatis dari sistem">
                            </div>
                        </div>
                        <div class="row mb-1">
                            <div class="col-lg-3 mt-2">
                        ...
                        <div class="row mb-1">
                            <div class="col-lg-3">
                                <label for="tanggal_trx" class="form-label">Keterangan</label>
                            </div>
                            <div class="col-lg-9">
                                <input required type="text" class="form-control" id="keterangan_trx" placeholder="Berikan keterangan, jika ada">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-3 mt-2">
